                ...
                <div className="flex flex-col lg:flex-row items-center gap-12">
                    ...
                    <div className="lg:w-1/2">
                        ...
                        <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                            Experience the vibrant culture, history, and hospitality of Accra, Ghana&apos;s capital city. Accra is a bustling metropolis that perfectly blends tradition with modernity, offering attendees a unique backdrop for learning and networking.
                        </p>
