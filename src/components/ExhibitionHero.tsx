                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 text-center">
                            The Atlas Global Academic Conference Exhibition
                        </h1>
                        ...
                        <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
                            ...
                            <p>
                                Would you like to position your organisation as a market leader to the Atlas Global Academic Conference community of learning, training, technology professionals and decision makers? Contact us at{" "}
